...
console.log("Comapred to dataset:", dataset)
            //Data, stacked
            stack(dataset);
...
console.log("ataset[0][0]", dataset[0][0].time)
console.log("dataset[0][dataset[0].length-1].time", d3.time.day.offset(new Date(dataset[0][dataset[0].length-1].time),8))
console.log(stats)

dataset = stats[cid].hourly
            //Set up scales
            ...
            var rects = groups.selectAll("rect")
                .data(function(d) { console.log("rectd", d); return d; })
                .enter()
                .append("rect")
                .attr("width", 2)
